 ...
 */
// ------------------------------------------------------------------------
$_logger->info('Including CodeIgniter required files');
/**
 ...
 *
 */
$_logger->debug('[Starting] Loading CodeIgniter base controller class');
...
$_logger->debug('[Starting] Loading user defined base controller class');
if (file_exists(APPPATH . 'core/' . $CFG->config['subclass_prefix'] . 'Controller.php')) {
    require APPPATH . 'core/' . $CFG->config['subclass_prefix'] . 'Controller.php';
}

$_logger->debug('[Starting] Loading local base controller class');
...
$_logger->debug('[Starting] Checking requested class and requested method... ');
...
if (method_exists($CI, '_remap')) {
    ...
    try {
        ...
        show_error('An Error Was Encountered', 500, 'An Error Was Encountered', $e);
    }
}
